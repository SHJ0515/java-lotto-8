...
- 입력 예외 처리
    - [x] 로또 구입 금액이 양의 정수가 아닐 시 예외 처리
    - [x] 로또 구입 금액이 1000원 단위가 아닐 시 예외 처리
    - [x] 로또 최대구매금액 100000원으로 제한 및 검증
    - [x] 당첨 번호 입력 시 구분자(쉼표)가 연달아 오는경우 예외 처리
    - [x] 당첨 번호 입력 시 처음 또는 마지막 문자가 구분자일 경우 예외 처리
    - [x] 당첨 번호 입력 시 1 ~ 45 사이의 양의 정수가 아닐 시 예외 처리
    - [x] 당첨 번호를 6개 입력하지 않을 시 예외 처리
    - [x] 보너스 번호 입력 시 1 ~ 45 사이의 양의 정수가 아닐 시 예외 처리
    - [x] 보너스 번호 입력 시 당첨 번호에 포함 된 수 입력 시 예외 처리
